...
class TriangleContainer@JvmOverloads constructor(
    ...
    private val defaultShadowWidth = 8.dpToPx()
    private val defaultPadding = 20.dpToPx()
    private val defaultTrvWidth = 25.dpToPx()
    private val defaultTrvHeight = 15.dpToPx()
    private val defaultRadius = 5.dpToPx()
