...
import com.qtk.kotlintest.contant.ContantsKt;
    ...
    private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        ...
        switch (Example.authorizationState.getConstructor()) {
            case TdApi.AuthorizationStateWaitTdlibParameters.CONSTRUCTOR:
                TdApi.TdlibParameters parameters = new TdApi.TdlibParameters(true, Utils.getApp().getFilesDir().getAbsolutePath() + "/",
                        Utils.getApp().getExternalFilesDir(null).getAbsolutePath() + "/", true, true,
                        true, false, ContantsKt.TELE_API_ID, ContantsKt.TELE_API_HASH, "zh", "Android",
                        null, AppUtils.getAppVersionName(), true, true);
                /*parameters.useTestDc = true;
                parameters.databaseDirectory = Utils.getApp().getFilesDir().getAbsolutePath() + "/";
                parameters.filesDirectory = Utils.getApp().getExternalFilesDir(null).getAbsolutePath() + "/";
                parameters.useFileDatabase = true;
                parameters.useChatInfoDatabase = true;
                parameters.useMessageDatabase = true;
                parameters.useSecretChats = false;
                parameters.apiId = ContantsKt.TELE_API_ID;
                parameters.apiHash = ContantsKt.TELE_API_HASH;
                parameters.systemLanguageCode = "zh";
                parameters.deviceModel = "Android";
                parameters.applicationVersion = AppUtils.getAppVersionName();
            ...
            case TdApi.AuthorizationStateWaitPhoneNumber.CONSTRUCTOR: {
                String phoneNumber = "15884594828";
